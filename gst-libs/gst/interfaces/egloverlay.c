...
#include "egloverlay.h"

static void gst_egl_overlay_base_init (gpointer g_class);

GType
gst_egl_overlay_get_type (void)
{
  static GType gst_egl_overlay_type = 0;

  if (!gst_egl_overlay_type) {
    static const GTypeInfo gst_egl_overlay_info = {
      sizeof (GstEGLOverlayClass),
      gst_egl_overlay_base_init,
      NULL,
      NULL,
      NULL,
      NULL,
    ...
    gst_egl_overlay_type = g_type_register_static (G_TYPE_INTERFACE,
        "GstEGLOverlay", &gst_egl_overlay_info, 0);
    g_type_interface_add_prerequisite (gst_egl_overlay_type,
        GST_TYPE_IMPLEMENTS_INTERFACE);
  }

  return gst_egl_overlay_type;
}

static void
gst_egl_overlay_base_init (gpointer g_class)
{
 ...
 */
void
gst_egl_overlay_set_window_handle (GstEGLOverlay * overlay, guintptr handle)
{
  GstEGLOverlayClass *klass;

  g_return_if_fail (overlay != NULL);
  g_return_if_fail (GST_IS_EGL_OVERLAY (overlay));

  klass = GST_EGL_OVERLAY_GET_CLASS (overlay);
 ...
 */
void
gst_egl_overlay_got_window_handle (GstEGLOverlay * overlay, guintptr handle)
{
  GstStructure *s;
  GstMessage *msg;
 ...
 */
void
gst_egl_overlay_prepare_window_id (GstEGLOverlay * overlay)
{
  GstStructure *s;
  GstMessage *msg;
 ...
 */
void
gst_egl_overlay_expose (GstEGLOverlay * overlay)
{
  GstEGLOverlayClass *klass;
 ...
 */
void
gst_egl_overlay_handle_events (GstEGLOverlay * overlay, gboolean handle_events)
{
  GstEGLOverlayClass *klass;
...
/**
 * gst_egl_overlay_set_render_rectangle:
 ...
 */
gboolean
gst_egl_overlay_set_render_rectangle (GstEGLOverlay * overlay,
    gint x, gint y, gint width, gint height)
{
  GstEGLOverlayClass *klass;

  g_return_val_if_fail (overlay != NULL, FALSE);
  g_return_val_if_fail (GST_IS_EGL_OVERLAY (overlay), FALSE);
